//
// Generated file, do not edit! Created by opp_msgtool 6.1 from updateFulfillHTLC.msg.
//
...
UpdateFulfillHTLCDescriptor::UpdateFulfillHTLCDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(UpdateFulfillHTLC)), "omnetpp::cPacket")
{
...
int UpdateFulfillHTLCDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "preImage") == 0) return baseIndex + 2;
...
int UpdateFulfillHTLCDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    UpdateFulfillHTLC *pp = omnetpp::fromAnyPtr<UpdateFulfillHTLC>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void UpdateFulfillHTLCDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    UpdateFulfillHTLC *pp = omnetpp::fromAnyPtr<UpdateFulfillHTLC>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'UpdateFulfillHTLC'", field);
    }
}

const char *UpdateFulfillHTLCDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string UpdateFulfillHTLCDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_preImage: return oppstring2string(pp->getPreImage());
        case FIELD_value: return double2string(pp->getValue());
        default: return "";
    }
}

void UpdateFulfillHTLCDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        case FIELD_preImage: pp->setPreImage((value)); break;
        case FIELD_value: pp->setValue(string2double(value)); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'UpdateFulfillHTLC'", field);
    }
}

omnetpp::cValue UpdateFulfillHTLCDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_preImage: return pp->getPreImage();
        case FIELD_value: return pp->getValue();
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'UpdateFulfillHTLC' as cValue -- field index out of range?", field);
    }
}

void UpdateFulfillHTLCDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        case FIELD_preImage: pp->setPreImage(value.stringValue()); break;
...
omnetpp::any_ptr UpdateFulfillHTLCDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void UpdateFulfillHTLCDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
